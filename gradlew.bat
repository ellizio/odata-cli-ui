...
if "%WIN_ARCH%" equ "AMD64" (
    set JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.9_windows-x64_bin.zip\
    set JVM_TARGET_DIR=%BUILD_DIR%\jdk-21.0.9_windows-x64_bin-020648
) else if "%WIN_ARCH%" equ "ARM64" (
    set JVM_URL=https://aka.ms/download-jdk/microsoft-jdk-21.0.9-windows-aarch64.zip\
    set JVM_TARGET_DIR=%BUILD_DIR%\microsoft-jdk-21.0.9-windows-aarch64-351ba0
) else (
